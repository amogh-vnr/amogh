        ...
        <div className="exp-card">
          <div className="exp-card-header">
            ...
            <div style={{ textAlign: 'right' }}>
              <span className="role">Junior Analyst Intern</span>
            </div>
          </div>
          
          <div className="exp-tech-tags">
            <span className="exp-tech-tag">Oracle Database</span>
            <span className="exp-tech-tag">SQL</span>
            <span className="exp-tech-tag">Oracle SQL Developer</span>
            <span className="exp-tech-tag">ServiceNow</span>
            <span className="exp-tech-tag">Production Support</span>
          </div>
          ...
          <ul>
            ...
            <li>Collaborated closely with Database Administration (DBA) teams to shadow production system health monitoring, user access management, and backup/recovery validation protocols for cloud databases.</li>
